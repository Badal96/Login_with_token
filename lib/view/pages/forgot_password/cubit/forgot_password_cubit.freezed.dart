...
class _$ForgotPasswordStateImpl implements _ForgotPasswordState {
  const _$ForgotPasswordStateImpl({this.isLoading = false});
  ...
  @override
  String toString() {
    return 'ForgotPasswordState(isLoading: $isLoading)';
  }
...
abstract class _ForgotPasswordState implements ForgotPasswordState {
  const factory _ForgotPasswordState({final bool isLoading}) =
